...
const axios = require("axios"); // eslint-disable-next-line camelcase
...
class LoggedInUserService {
  ...
  async getLoggedUser(ctx, logger) {
    ...
    try {
      ...
      logger.error("Error getting user data", err); // eslint-disable-next-line no-cond-assign,no-void
...
//# sourceMappingURL=LoggedInUserService.js.map